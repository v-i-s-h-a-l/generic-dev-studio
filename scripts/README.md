...
scripts/resolve-reviewer.sh --impl-host claude-code     # catalog-driven host+model+effort pick (#322)
scripts/pr-headless-review.sh <pr> [--impl-host h]      # run eligible reviewer, post gate, merge if non-blocked
