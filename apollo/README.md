...
> **Status (Stage 4 scaffold).** This file lands the SKILL.md, routing.yaml, and docs surface. P0 mode packs (memory / thermal / battery) ship in Stage 2 (#230, #231, #232). Until then, `/apollo <metric>` refuses with a pointer to the tracking issue.
