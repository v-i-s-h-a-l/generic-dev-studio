...
- **Studio v2 substrate spec strand (#444 A0-A0.6)** — The v2 greenfield substrate is being specified before implementation. The first checked-in A0 artifact is [`core/RESEARCH.md`](core/RESEARCH.md), which maps OSS agent-framework research to the 12 Studio v2 principles and feeds the later A0.5 `SPEC.md`.
