...
- Achilles `task` mode marked `dry_run: true` (Phase 2.5 Commit F pilot — the mode pack implements simulated writes + buffered events). Other modes remain `dry_run: false` until 2.6 rewrites adopt the pattern.
