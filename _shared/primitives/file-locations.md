...
| Test-case projections | `~/.dev-studio/<project>/plans/chanakya-inbox/<task-id>-tests.md` | Human-facing projection written by `scripts/task-write-test-cases.sh`; canonical test cases live in debrief YAML `tests.added` / `tests.modified`. |
