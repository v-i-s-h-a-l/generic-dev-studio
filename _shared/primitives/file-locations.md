...
| Studio v2 checkpoint index | `~/.dev-studio/<project>/.runtime/v2/checkpoints/index.json` | `core/v2/checkpoints/CONTRACT.md` |
| Studio v2 checkpoint session | `~/.dev-studio/<project>/.runtime/v2/checkpoints/sessions/<checkpoint-id>/` | `core/v2/checkpoints/CONTRACT.md` |
...
| Test-case artifacts | `~/.dev-studio/<project>/plans/chanakya-inbox/<task-id>-tests.md` | Historical/import-only. Active readers use linked debrief YAML `tests.added` / `tests.modified`; no active writer targets this path. |
